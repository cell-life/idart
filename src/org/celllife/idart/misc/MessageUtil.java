...
public class MessageUtil {
	...
	public static String getIDARTWebCrashMessage() {
		String message = "An error has occurred while connecting to iDARTweb. \n\n "
				+ "Please try again later. If this error persists, please contact the iDART Help Desk. " 
				+ "To see the technical reasons for this crash, "
				+ "please click on the 'Details' button.\n\n"
				+ "Version infromation:"
				+ "\niDART version: "
					+ iDartProperties.idartVersionNumber;
